...
2026-09-08 GitHub Pages 공개본에서 초기 표시, 옵션 기본 해제, 섀시 단독·섀시와 거치대 동시 선택, 우측 방향 전환을 확인했습니다. 다른 방향, 회전·확대, 네 다운로드 파일은 브라우저 전수 검사가 남아 있습니다. 현재 STL 4종은 닫힌 메시와 단일 연결체 검증을 통과했으며 HTML에 포함된 데이터와 일치합니다.
